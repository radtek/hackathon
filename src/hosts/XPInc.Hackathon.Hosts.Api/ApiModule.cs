...
// using Corporate.Coe.Asset.Hosts.Api.Configuration;
// using Corporate.Coe.Asset.Hosts.BackgroundService.Middlewares;
// using Corporate.COE.Framework.Monitoring.HealthCheck;
// using Corporate.COE.Framework.Security.Options;
...
//                 .Bind(configuration.GetSection(AuthenticationOptions.DefaultSectionPath))
//                 .ValidateDataAnnotations();
